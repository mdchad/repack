                    ...
                    <li key={id}>
                      <Link
                        href={`/dashboard/${urlType(
                          saveContent.subtype,
                          saveContent.saved.value
                        )}`}
                      >
                        <a
                          className="border rounded-lg p-5 flex justify-between items-center hover:bg-[#F38A7A]/10 hover:border-[#F38A7A]"
                          target="_blank"
                        >
                          <div className="flex flex-col gap-1">
                            ...
                            <p className="text-sm text-gray-500">
                              {moment(saveContent.created_at).fromNow()}
                            </p>
                          </div>
