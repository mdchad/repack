        ...
        <div className='flex flex-col gap-10'>
            ...
            <section className="flex flex-col gap-3">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 divide-x gap-4 m-1'>
                    <a href="#" className="block p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 overflow-hidden ring-inset">
            ...
            <section className="flex flex-col gap-2 mb-8">
                ...
                <p className='text-sm'>Get started by selecting the content type from the options below</p>
