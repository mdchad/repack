...
function DashboardShortCut() {
  ...
  return (
    <div className="grid place-items-center container mx-auto lg:hidden">
      <div
        id="drawer-swipe"
        className="fixed bottom-0 z-40 w-full overflow-y-auto bg-white border border-gray-200 rounded-t-lg dark:border-gray-700 dark:bg-gray-800"
        aria-labelledby="drawer-swipe-label"
      >
        <button
          ref={targetEl}
          onClick={() => setDrawerToggle(!drawerToggle)}
          className="flex items=center p-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 w-full text-left"
        ...
        <div
          className={`${
            drawerToggle ? 'grid' : 'hidden'
          } grid grid-cols-3 gap-4 p-4 lg:grid-cols-4 transition-all`}
          id="children-grid"
        >
