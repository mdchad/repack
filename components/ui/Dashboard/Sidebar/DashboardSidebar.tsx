        ...
        <>
            ...
            <div className="h-0 flex-1 overflow-y-auto p-5 flex flex-col justify-between">
                ...
                <div id="bottom-section">
                    ...
                    <div id="dropdown-cta" className="p-4 mt-6 bg-gray-50 rounded-lg dark:bg-gray-900" role="alert">
                        <div className="flex items-center mb-3">
                            ...
                            <button type="button" className="ml-auto -mx-1.5 -my-1.5 bg-gray-50 text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-400 p-1 hover:bg-gray-200 inline-flex h-6 w-6 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800" data-collapse-toggle="dropdown-cta" aria-label="Close">
