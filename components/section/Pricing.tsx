            ...
            <div className="container mx-auto">
                <div className="mx-">
                    <div className="flex flex-col items-center mb-6">
                        <p className='text-[#F1887A] uppercase tracking-[.25em]'>Select your plan</p>
                        <h1 className='text-left pb-[25px] md:text-[39px] text-[25px] dark:text-[#EBD9A1] text-[#293C4A]'>Level up your work</h1>
                    </div>
                        ...
                        <div className="flex flex-wrap flex-row justify-center gap-8">
                            ...
                            {pricing.map((item, index) => (
                                <Card key={index} className="max-w-sm">
                                    <div>
                                        <h1 className="text-xl font-medium capitalize text-gray-700 dark:text-white lg:text-3xl">{item.title}</h1>
                                        ...
                                        <span className="mt-4 text-2xl font-medium text-gray-700 dark:text-gray-300 sm:text-4xl flex items-baseline gap-3">
                                            {item.price}
                                            <h5 className="text-sm font-medium">{item.payment_type}</h5>
                                        </span>

                                        <p className="mt-1 text-gray-500 dark:text-gray-300">{item.payment_description}</p>
                                        ...
                                        <div className="space-y-4">
                                            {item.features.map((feature, index) => (
                                                <div key={index} className="flex items-center gap-3">
                                                    ...
                                                    <p className="text-gray-500 dark:text-gray-300">{feature.label}</p>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
